...
public class ContinentFactory {
	...
	private static Continent createAsia(){
		...
		List<City> cities = new ArrayList<City>();
		cities.add(new City("ShanghaiShanghaiShanghai", 100, new MeteorShower()));
		cities.add(new City("TokyoTokyoTokyoTokyo", 75, new MeteorShower()));
		cities.add(new City("DubaiDubaiDubaiDubai", 50, new MeteorShower()));
		return new Continent("AsiaAsiaAsiaAsiaAsia", cities);
	}
	
	private static Continent createAmerica(){
		List<City> cities = new ArrayList<City>();
		cities.add(new City("NewYorkNewYorkNewYork", 100, new MeteorShower()));
		cities.add(new City("WashingtonWashington", 75, new MeteorShower()));
		cities.add(new City("OttawaOttawaOttawaOttawa", 50, new MeteorShower()));
		return new Continent("AmericaAmericaAmerica", cities);
	}
	
	private static Continent createAntarctica(){
		List<City> cities = new ArrayList<City>();
		cities.add(new City("SouthPoleSouthPoleSouthPole", 100, new MeteorShower()));
		cities.add(new City("IceIceIceIceIceIceIceIce", 75, new MeteorShower()));
		cities.add(new City("MountainMountainMountain", 50, new MeteorShower()));
